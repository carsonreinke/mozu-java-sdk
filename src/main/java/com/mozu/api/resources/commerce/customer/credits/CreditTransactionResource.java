...
public class CreditTransactionResource {
	 ...
	 * <p><pre><code>
	 *	CreditTransaction credittransaction = new CreditTransaction();
	 *	CreditTransactionCollection creditTransactionCollection = credittransaction.GetTransactions( code,  startIndex,  pageSize,  sortBy,  filter, authTicket);
	 * </code></pre></p>
	 * @param code User-defined code that identifies the customer credit.
	 ...
	 * @see com.mozu.api.contracts.customer.credit.CreditTransactionCollection
	 */
	public com.mozu.api.contracts.customer.credit.CreditTransactionCollection getTransactions(String code, Integer startIndex, Integer pageSize, String sortBy, String filter, AuthTicket authTicket) throws Exception
	{
		MozuClient<com.mozu.api.contracts.customer.credit.CreditTransactionCollection> client = com.mozu.api.clients.commerce.customer.credits.CreditTransactionClient.getTransactionsClient( code,  startIndex,  pageSize,  sortBy,  filter, authTicket);
	 ...
	 * <p><pre><code>
	 *	CreditTransaction credittransaction = new CreditTransaction();
	 *	CreditTransaction creditTransaction = credittransaction.AddTransaction( creditTransaction,  code, authTicket);
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.customer.credit.CreditTransaction
	 */
	public com.mozu.api.contracts.customer.credit.CreditTransaction addTransaction(com.mozu.api.contracts.customer.credit.CreditTransaction creditTransaction, String code, AuthTicket authTicket) throws Exception
	{
		MozuClient<com.mozu.api.contracts.customer.credit.CreditTransaction> client = com.mozu.api.clients.commerce.customer.credits.CreditTransactionClient.addTransactionClient( creditTransaction,  code, authTicket);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
