...
/**
	...
	* @see string
	*/
	public ArrayList<String> getAvailablePaymentActions(String orderId, String paymentId) throws Exception
	{
		MozuClient<ArrayList<String>> client = com.mozu.api.clients.commerce.orders.PaymentClient.getAvailablePaymentActionsClient( orderId,  paymentId);
		setContext(_apiContext, client,true);
		client.executeRequest();
		return client.getResult();
	...
	* <p><pre><code>
	*    Payment payment = new Payment();
	*   Order order = payment.PerformPaymentAction( orderId,  paymentId,  action);
	* </code></pre></p>
	* @param orderId Unique identifier of the order associated with the payment.
	...
	*/
	public com.mozu.api.contracts.commerceruntime.orders.Order performPaymentAction(String orderId, String paymentId, com.mozu.api.contracts.commerceruntime.payments.PaymentAction action) throws Exception
	{
		MozuClient<com.mozu.api.contracts.commerceruntime.orders.Order> client = com.mozu.api.clients.commerce.orders.PaymentClient.performPaymentActionClient( orderId,  paymentId,  action);
		setContext(_apiContext, client,true);
		client.executeRequest();
		return client.getResult();
...
/**
	...
	* <p><pre><code>
	*    Payment payment = new Payment();
	*   Order order = payment.CreatePaymentAction( orderId,  action);
	* </code></pre></p>
	...
	* @see com.mozu.api.contracts.commerceruntime.payments.PaymentAction
	*/
	public com.mozu.api.contracts.commerceruntime.orders.Order createPaymentAction(String orderId, com.mozu.api.contracts.commerceruntime.payments.PaymentAction action) throws Exception
	{
		MozuClient<com.mozu.api.contracts.commerceruntime.orders.Order> client = com.mozu.api.clients.commerce.orders.PaymentClient.createPaymentActionClient( orderId,  action);
		setContext(_apiContext, client,true);
		client.executeRequest();
		return client.getResult();
