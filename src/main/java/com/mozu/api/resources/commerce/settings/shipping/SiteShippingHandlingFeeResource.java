...
public class SiteShippingHandlingFeeResource {
	 ...
	 */
	public com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee getOrderHandlingFee(AuthTicket authTicket) throws Exception
	{
		MozuClient<com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee> client = com.mozu.api.clients.commerce.settings.shipping.SiteShippingHandlingFeeClient.getOrderHandlingFeeClient(authTicket);
	 ...
	 * @see com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee
	 */
	public com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee createOrderHandlingFee(com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee orderHandlingFee, AuthTicket authTicket) throws Exception
	{
		MozuClient<com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee> client = com.mozu.api.clients.commerce.settings.shipping.SiteShippingHandlingFeeClient.createOrderHandlingFeeClient( orderHandlingFee, authTicket);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * @see com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee
	 */
	public com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee updateOrderHandlingFee(com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee orderHandlingFee, AuthTicket authTicket) throws Exception
	{
		MozuClient<com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee> client = com.mozu.api.clients.commerce.settings.shipping.SiteShippingHandlingFeeClient.updateOrderHandlingFeeClient( orderHandlingFee, authTicket);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
