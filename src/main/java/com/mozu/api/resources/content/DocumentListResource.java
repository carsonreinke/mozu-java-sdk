...
public class DocumentListResource {
	 ...
	 * <p><pre><code>
	 *	DocumentList documentlist = new DocumentList();
	 *	DocumentList documentList = documentlist.GetDocumentList(dataViewMode,  documentListName, authTicket);
	 * </code></pre></p>
	 ...
	 */
	public com.mozu.api.contracts.content.DocumentList getDocumentList(com.mozu.api.DataViewMode dataViewMode, String documentListName, AuthTicket authTicket) throws Exception
	{
		MozuClient<com.mozu.api.contracts.content.DocumentList> client = com.mozu.api.clients.content.DocumentListClient.getDocumentListClient(dataViewMode,  documentListName, authTicket);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
