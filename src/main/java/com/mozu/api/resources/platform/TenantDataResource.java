...
/// </summary>
public class TenantDataResource extends BaseResource {
	///
	...
	*/
	...
	{
		MozuClient client = com.mozu.api.clients.platform.TenantDataClient.createDBValueClient( dbEntryQuery,  value);
		setContext(_apiContext, client,true);
		client.executeRequest();
	...
	*/
	...
	{
		MozuClient client = com.mozu.api.clients.platform.TenantDataClient.updateDBValueClient( dbEntryQuery,  value);
		setContext(_apiContext, client,true);
		client.executeRequest();
