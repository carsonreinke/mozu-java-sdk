...
/// </summary>
public class SiteDataResource extends BaseResource {
	///
	...
	*/
	...
	{
		MozuClient client = com.mozu.api.clients.platform.SiteDataClient.createDBValueClient( dbEntryQuery,  value);
		setContext(_apiContext, client,true);
		client.executeRequest();
	...
	*/
	...
	{
		MozuClient client = com.mozu.api.clients.platform.SiteDataClient.updateDBValueClient( dbEntryQuery,  value);
		setContext(_apiContext, client,true);
		client.executeRequest();
