...
/// </summary>
public class EventNotificationResource extends BaseResource {
	///
...
/**
	...
	* <p><pre><code>
	*    EventNotification eventnotification = new EventNotification();
	*   EventCollection eventCollection = eventnotification.GetEvents( filter,  pageSize,  sortBy,  startIndex);
	* </code></pre></p>
	...
	* @see com.mozu.api.contracts.event.EventCollection
	*/
	public com.mozu.api.contracts.event.EventCollection getEvents(String filter, Integer pageSize, String sortBy, Integer startIndex) throws Exception
	{
		MozuClient<com.mozu.api.contracts.event.EventCollection> client = com.mozu.api.clients.event.EventNotificationClient.getEventsClient( filter,  pageSize,  sortBy,  startIndex);
