...
public class ProductTypeVariationUrl
{
    ...
    */
	public static String generateProductVariationsUrl(String filter, Integer pageSize, String productCode, Integer productTypeId, String sortBy, Integer startIndex)
	{
