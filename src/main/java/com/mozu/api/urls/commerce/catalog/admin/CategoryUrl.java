...
public class CategoryUrl
{
    ...
    */
	public static String getCategoriesUrl(String filter, Integer pageSize, String sortBy, Integer startIndex)
	{
	...
	/**
        ...
        * @return    String Resource Url
    */
	public static String getCategoryUrl(Integer categoryId)
	{
	...
	/**
        ...
        * @return    String Resource Url
    */
	public static String getChildCategoriesUrl(Integer categoryId)
	{
    ...
    */
	public static String addCategoryUrl()
	{
        ...
        * @return    String Resource Url
    */
	public static String updateCategoryUrl(Boolean cascadeVisibility, Integer categoryId)
	{
        ...
        * @return    String Resource Url
    */
	public static String deleteCategoryByIdUrl(Boolean cascadeDelete, Integer categoryId)
	{
