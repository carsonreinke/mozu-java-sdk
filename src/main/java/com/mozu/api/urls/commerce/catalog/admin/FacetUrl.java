...
public class FacetUrl
{
    ...
    */
	public static String getFacetUrl(Integer facetId, Boolean validate)
	{
	...
	/**
        ...
        * @return    String Resource Url
    */
	public static String getFacetCategoryListUrl(Integer categoryId, Boolean includeAvailable, Boolean validate)
	{
    ...
    */
	public static String addFacetUrl()
	{
        ...
        * @return    String Resource Url
    */
	public static String updateFacetUrl(Integer facetId)
	{
        ...
        * @return    String Resource Url
    */
	public static String deleteFacetByIdUrl(Integer facetId)
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/catalog/admin/facets/{facetId}");
		formatter.formatUrl("facetId", facetId);
		return formatter.getResourceUrl();
