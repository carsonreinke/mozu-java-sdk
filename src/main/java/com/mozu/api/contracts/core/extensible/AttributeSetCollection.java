...
*/
public class AttributeSetCollection implements Serializable
{
	...
	*/
	@JsonProperty("Items")
	protected ArrayList<AttributeSet> items;
	public ArrayList<AttributeSet> getItems() {
		return this.items;
	}
	public void setItems(ArrayList<AttributeSet> items) {
		this.items = items;
	}
