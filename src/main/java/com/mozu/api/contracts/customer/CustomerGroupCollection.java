...
*/
public class CustomerGroupCollection implements Serializable
{
	...
	*/
	@JsonProperty("Items")
	protected ArrayList<CustomerGroup> items;
	public ArrayList<CustomerGroup> getItems() {
		return this.items;
	}
	public void setItems(ArrayList<CustomerGroup> items) {
		this.items = items;
	}
