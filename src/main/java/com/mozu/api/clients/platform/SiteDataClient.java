...
public class SiteDataClient {
	...
	*/
	...
	{
		String url = com.mozu.api.urls.platform.SiteDataUrl.getDBValueUrl(dbEntryQuery);
		String verb = "GET";
	...
	*/
	...
	{
		String url = com.mozu.api.urls.platform.SiteDataUrl.createDBValueUrl(dbEntryQuery);
		String verb = "POST";
	...
	*/
	...
	{
		String url = com.mozu.api.urls.platform.SiteDataUrl.updateDBValueUrl(dbEntryQuery);
		String verb = "PUT";
				MozuClient mozuClient = new MozuClient();
		mozuClient.setVerb(verb);
		mozuClient.setResourceUrl(url);
	...
	*/
	...
	{
		String url = com.mozu.api.urls.platform.SiteDataUrl.deleteDBValueUrl(dbEntryQuery);
		String verb = "DELETE";
				MozuClient mozuClient = new MozuClient();
		mozuClient.setVerb(verb);
		mozuClient.setResourceUrl(url);
