...
public class AuthTicketClient {
	...
	*/
	...
	{
		String url = com.mozu.api.urls.platform.applications.AuthTicketUrl.authenticateAppUrl();
		String verb = "POST";
	...
	*/
	...
	{
		String url = com.mozu.api.urls.platform.applications.AuthTicketUrl.refreshAppAuthTicketUrl();
		String verb = "PUT";
		Class<?> clz = com.mozu.api.contracts.appdev.AuthTicket.class;
		MozuClient<com.mozu.api.contracts.appdev.AuthTicket> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
	...
	*/
	...
	{
		String url = com.mozu.api.urls.platform.applications.AuthTicketUrl.deleteAppAuthTicketUrl(refreshToken);
		String verb = "DELETE";
