...
public class TenantDataClient {
	...
	*/
	...
	{
		String url = com.mozu.api.urls.platform.TenantDataUrl.getDBValueUrl(dbEntryQuery);
		String verb = "GET";
	...
	* <p><pre><code>
	*   MozuClient mozuClient=CreateDBValueClient( dbEntryQuery,  value);
	* client.setBaseAddress(url);
	* client.executeRequest();
	* </code></pre></p>
	...
	* @see string
	*/
	public static MozuClient createDBValueClient(String dbEntryQuery, String value) throws Exception
	{
		String url = com.mozu.api.urls.platform.TenantDataUrl.createDBValueUrl(dbEntryQuery);
		String verb = "POST";
	...
	* <p><pre><code>
	*   MozuClient mozuClient=UpdateDBValueClient( dbEntryQuery,  value);
	* client.setBaseAddress(url);
	* client.executeRequest();
	* </code></pre></p>
	...
	* @see string
	*/
	public static MozuClient updateDBValueClient(String dbEntryQuery, String value) throws Exception
	{
		String url = com.mozu.api.urls.platform.TenantDataUrl.updateDBValueUrl(dbEntryQuery);
		String verb = "PUT";
				MozuClient mozuClient = new MozuClient();
		mozuClient.setVerb(verb);
		mozuClient.setResourceUrl(url);
	...
	*/
	...
	{
		String url = com.mozu.api.urls.platform.TenantDataUrl.deleteDBValueUrl(dbEntryQuery);
		String verb = "DELETE";
				MozuClient mozuClient = new MozuClient();
		mozuClient.setVerb(verb);
		mozuClient.setResourceUrl(url);
