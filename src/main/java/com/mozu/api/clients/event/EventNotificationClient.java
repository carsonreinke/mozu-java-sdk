...
/**
	* Retrieves a list of events.
	* <p><pre><code>
	*   MozuClient<com.mozu.api.contracts.event.EventCollection> mozuClient=GetEventsClient( filter,  pageSize,  sortBy,  startIndex);
	* client.setBaseAddress(url);
	* client.executeRequest();
	* EventCollection eventCollection = client.Result();
	* </code></pre></p>
	...
	* @see com.mozu.api.contracts.event.EventCollection
	*/
	public static MozuClient<com.mozu.api.contracts.event.EventCollection> getEventsClient(String filter, Integer pageSize, String sortBy, Integer startIndex) throws Exception
	{
		String url = com.mozu.api.urls.event.EventNotificationUrl.getEventsUrl(filter, pageSize, sortBy, startIndex);
		String verb = "GET";
...
/**
	...
	*/
	...
	{
		String url = com.mozu.api.urls.event.EventNotificationUrl.getEventUrl(eventId);
		String verb = "GET";
