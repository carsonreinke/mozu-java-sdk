...
public class EventNotificationClient {
	 ...
	 * Retrieves a list of events.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.event.EventCollection> mozuClient=GetEventsClient( startIndex,  pageSize,  sortBy,  filter, authTicket);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * EventCollection eventCollection = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.event.EventCollection
	 */
	public static MozuClient<com.mozu.api.contracts.event.EventCollection> getEventsClient(Integer startIndex, Integer pageSize, String sortBy, String filter, AuthTicket authTicket) throws Exception
	{
