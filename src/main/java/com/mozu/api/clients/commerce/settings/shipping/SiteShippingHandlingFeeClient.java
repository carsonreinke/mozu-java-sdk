...
public class SiteShippingHandlingFeeClient {
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.settings.shipping.SiteShippingHandlingFeeUrl.getOrderHandlingFeeUrl();
		String verb = "GET";
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.settings.shipping.SiteShippingHandlingFeeUrl.createOrderHandlingFeeUrl();
		String verb = "POST";
		Class<?> clz = com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee.class;
		MozuClient<com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.settings.shipping.SiteShippingHandlingFeeUrl.updateOrderHandlingFeeUrl();
		String verb = "PUT";
		Class<?> clz = com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee.class;
		MozuClient<com.mozu.api.contracts.sitesettings.shipping.SiteShippingHandlingFee> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
