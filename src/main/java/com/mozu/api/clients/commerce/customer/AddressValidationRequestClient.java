...
public class AddressValidationRequestClient {
	 ...
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.customer.AddressValidationResponse> mozuClient=ValidateAddressClient( addressValidationRequest, authTicket);
	 ...
	 */
	public static MozuClient<com.mozu.api.contracts.customer.AddressValidationResponse> validateAddressClient(com.mozu.api.contracts.customer.AddressValidationRequest addressValidationRequest, AuthTicket authTicket) throws Exception
	{
