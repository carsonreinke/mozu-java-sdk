...
public class CreditClient {
	 ...
	 * Retrieves a list of store credits applied to customer accounts, according any filter and sort criteria specified in the request.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.customer.credit.CreditCollection> mozuClient=GetCreditsClient( startIndex,  pageSize,  sortBy,  filter, authTicket);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * CreditCollection creditCollection = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.customer.credit.CreditCollection
	 */
	public static MozuClient<com.mozu.api.contracts.customer.credit.CreditCollection> getCreditsClient(Integer startIndex, Integer pageSize, String sortBy, String filter, AuthTicket authTicket) throws Exception
	{
	 ...
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.customer.credit.Credit> mozuClient=GetCreditClient( code, authTicket);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 ...
	 */
	public static MozuClient<com.mozu.api.contracts.customer.credit.Credit> getCreditClient(String code, AuthTicket authTicket) throws Exception
	{
	 ...
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.customer.credit.Credit> mozuClient=AddCreditClient( credit, authTicket);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * Credit credit = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.customer.credit.Credit
	 */
	public static MozuClient<com.mozu.api.contracts.customer.credit.Credit> addCreditClient(com.mozu.api.contracts.customer.credit.Credit credit, AuthTicket authTicket) throws Exception
	{
	 ...
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.customer.credit.Credit> mozuClient=UpdateCreditClient( credit,  code, authTicket);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * Credit credit = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.customer.credit.Credit
	 */
	public static MozuClient<com.mozu.api.contracts.customer.credit.Credit> updateCreditClient(com.mozu.api.contracts.customer.credit.Credit credit, String code, AuthTicket authTicket) throws Exception
	{
	 ...
	 */
	public static MozuClient deleteCreditClient(String code, AuthTicket authTicket) throws Exception
	{
