...
public class CartItemClient {
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.carts.CartItemUrl.getCartItemsUrl();
		String verb = "GET";
...
/**
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.carts.CartItemUrl.getCartItemUrl(cartItemId);
		String verb = "GET";
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.carts.CartItemUrl.addItemToCartUrl();
		String verb = "POST";
		Class<?> clz = com.mozu.api.contracts.commerceruntime.carts.CartItem.class;
		MozuClient<com.mozu.api.contracts.commerceruntime.carts.CartItem> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
	...
	* <p><pre><code>
	*   MozuClient<com.mozu.api.contracts.commerceruntime.carts.CartItem> mozuClient=UpdateCartItemClient( cartItemId,  cartItem);
	* client.setBaseAddress(url);
	* client.executeRequest();
	* CartItem cartItem = client.Result();
	* </code></pre></p>
	...
	* @see com.mozu.api.contracts.commerceruntime.carts.CartItem
	*/
	public static MozuClient<com.mozu.api.contracts.commerceruntime.carts.CartItem> updateCartItemClient(String cartItemId, com.mozu.api.contracts.commerceruntime.carts.CartItem cartItem) throws Exception
	{
		String url = com.mozu.api.urls.commerce.carts.CartItemUrl.updateCartItemUrl(cartItemId);
		String verb = "PUT";
		Class<?> clz = com.mozu.api.contracts.commerceruntime.carts.CartItem.class;
		MozuClient<com.mozu.api.contracts.commerceruntime.carts.CartItem> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
...
/**
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.carts.CartItemUrl.updateCartItemQuantityUrl(cartItemId, quantity);
		String verb = "PUT";
		Class<?> clz = com.mozu.api.contracts.commerceruntime.carts.CartItem.class;
		MozuClient<com.mozu.api.contracts.commerceruntime.carts.CartItem> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.carts.CartItemUrl.removeAllCartItemsUrl();
		String verb = "DELETE";
...
/**
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.carts.CartItemUrl.deleteCartItemUrl(cartItemId);
		String verb = "DELETE";
