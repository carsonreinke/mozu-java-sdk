...
public class PaymentClient {
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.orders.PaymentUrl.getPaymentsUrl(orderId);
		String verb = "GET";
...
/**
	...
	*/
	...
	{
		String url = com.mozu.api.urls.commerce.orders.PaymentUrl.getPaymentUrl(orderId, paymentId);
		String verb = "GET";
...
/**
	...
	* <p><pre><code>
	*   MozuClient<ArrayList<String>> mozuClient=GetAvailablePaymentActionsClient( orderId,  paymentId);
	* client.setBaseAddress(url);
	* client.executeRequest();
	...
	* @see string
	*/
	public static MozuClient<ArrayList<String>> getAvailablePaymentActionsClient(String orderId, String paymentId) throws Exception
	{
		String url = com.mozu.api.urls.commerce.orders.PaymentUrl.getAvailablePaymentActionsUrl(orderId, paymentId);
		String verb = "GET";
	...
	* <p><pre><code>
	*   MozuClient<com.mozu.api.contracts.commerceruntime.orders.Order> mozuClient=PerformPaymentActionClient( orderId,  paymentId,  action);
	* client.setBaseAddress(url);
	* client.executeRequest();
	...
	*/
	public static MozuClient<com.mozu.api.contracts.commerceruntime.orders.Order> performPaymentActionClient(String orderId, String paymentId, com.mozu.api.contracts.commerceruntime.payments.PaymentAction action) throws Exception
	{
		String url = com.mozu.api.urls.commerce.orders.PaymentUrl.performPaymentActionUrl(orderId, paymentId);
		String verb = "POST";
...
/**
	...
	* <p><pre><code>
	*   MozuClient<com.mozu.api.contracts.commerceruntime.orders.Order> mozuClient=CreatePaymentActionClient( orderId,  action);
	* client.setBaseAddress(url);
	* client.executeRequest();
	* Order order = client.Result();
	* </code></pre></p>
	...
	* @see com.mozu.api.contracts.commerceruntime.payments.PaymentAction
	*/
	public static MozuClient<com.mozu.api.contracts.commerceruntime.orders.Order> createPaymentActionClient(String orderId, com.mozu.api.contracts.commerceruntime.payments.PaymentAction action) throws Exception
	{
		String url = com.mozu.api.urls.commerce.orders.PaymentUrl.createPaymentActionUrl(orderId);
		String verb = "POST";
		Class<?> clz = com.mozu.api.contracts.commerceruntime.orders.Order.class;
		MozuClient<com.mozu.api.contracts.commerceruntime.orders.Order> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
