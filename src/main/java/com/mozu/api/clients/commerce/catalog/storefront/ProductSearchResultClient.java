...
public class ProductSearchResultClient {
	 ...
	 * Suggests possible search terms as the shopper enters search text.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.productruntime.SearchSuggestion> mozuClient=SuggestClient( q,  pageSize, authTicket);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * SearchSuggestion searchSuggestion = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.productruntime.SearchSuggestion
	 */
	public static MozuClient<com.mozu.api.contracts.productruntime.SearchSuggestion> suggestClient(String q, Integer pageSize, AuthTicket authTicket) throws Exception
	{
